                     ...
                     <tbody>
                        ...
                        <tr>
                            <td colspan="5" style="padding-top:20px;">
                                ...
                                <div class="car-info-group"  >
                                    ...
                                    <div class="car-info-2" @if($carinformation->assistance) style="margin-top:{{$carinformation->assist_row1.'px'}}; word-break: break-all !important;" @endif>
                                ...
                                <div class="car-info-group"  >
                                    ...
                                    <div class="car-info-2" @if($carinformation->comfirm) style="margin-top:{{$carinformation->b_contract_desc_row1.'px'}}; word-break: break-all !important;" @endif>
                                ...
                                <div style="width: 630px;border: 1px solid black;padding: 7px;margin-top: 24px;">
                                    <div style="padding-top: 5px;" >
                                        <div class="cal-col-1" >
                                             <strong style="font-size:16px;">Fahrzeugpreis:</strong>
                                        </div>
                                        <div class="cal-col-2" >
                                            &nbsp;&nbsp; &nbsp;
                                        </div>
                                    ...
                                    <div >
                                        <div class="cal-col-1" style="margin-top:-5px !important;" >
                                           <div style="margin-top:-5px !important; font-size:10px !important;"  >Steuerfreie Drittland Ausfuhr</div> 
                                           <div style="margin-top:-6px !important; font-size:10px !important;"  >§ 4 Nr. 1a i. V. m. §6 UStG</div>   
                                        </div>
                                        <div class="cal-col-middle" style="margin-top:-8px !important;" >
                        ...
                        <!-- <tr>
                            <td colspan="5" style="padding-top:12px;">
                                <div style="width: 100%;padding-top:10px;font-size: 13px;" class="text-left"> Das Fahrzeug wurde durch diie von Herrn Nyebe Dima bevollmächtigte Person Pierre Emmanuel Bodpa Kemdom besichtigt. Herr Bodpa Kmdom ist außerdem bevollmächtigt diesen Kaufvertrag zu unterschreiben und sich um alle Angelegenheiten um desen Fahrzeugkauf zu kümmern</div>
                            </td>
                        </tr> -->
