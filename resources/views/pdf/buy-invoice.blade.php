    ...
    <header >
        ...
        <div style="display: block !important;" >
            <div  class="buyer-info" >
                ...
                <div>{{$carinformation->s_street.' '.$carinformation->s_nummber}}</div>
                <div >{{$carinformation->s_postalcode.' '.$carinformation->s_city}}</div>
                <div >{{$carinformation->s_country}}</div>
            </div>
                     ...
                     <tbody>
                        ...
                        <tr >
                          <td colspan="5" >
                            <div style="border: 1px solid black !important;height: 41px:width:630px !important;">
	                            ...
	                            <div class="text-right" style="width: 240px; display: inline-block;font-size: 13px; ">    Stuhr, den {{$carinformation->s_saledate}}  </div>
                            </div>
                          </td>
                        </tr>
                        {{-- END : buyer-date-box --}}
                        ...
                        <tr>
                            <td colspan="5" style="padding-top:20px;">
                                ...
                                @if(isset($carinformation->s_note2) && $carinformation->s_note2 !='')
                                <div class="car-info-group">
                                    <div class="car-info-1">
                                ...
                                <div style="width: 630px;border: 1px solid black;padding: 7px;margin-top: 24px;">
                                    ...
                                    <div @if($carinformation->s_25a ==1) style="margin-top: -5px !important;" @else style="margin-top: -10px !important;" @endif>
                                        <div class="cal-col-1"   >
                                             @if($carinformation->s_25a ==1)Der Verkauf erfolgt nach §25a UStG    @endif
                                        </div>
                                        <div class="cal-col-middle" style="margin-top:-5px !important;" >
                                             ...
                                             <div style="right: 0px;width: 151px;display: inline-block;text-align: right;">
                                                ...
                                                @else
                                                   <strong> @convert(($carinformation->s_total))€</strong>
                                                @endif
                                             </div>
                                        </div>
                                    </div>
                                    <div  @if($carinformation->s_25a ==1) style="margin-top: -5px !important;" @else style="margin-top: -12px !important;" @endif">
                                        <div class="cal-col-1" >
                        ...
                        <tr>
                            <td colspan="5" style="padding-top:12px;">
                                <div style="width: 100%;padding-top:10px;font-size: 13px;" class="text-center"> Das Fahrzeug wurde vom Käufer ausgiebig besichtigt und Probe gefahren.</div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="5">
                                <div style="width: 100%;padding-bottom:26px;font-size: 13px;" class="text-center"> Gerichtsstand für beide ist Stuhr.</div>
                            </td>
                        </tr>
                        <!-- end : notification -->
                        <!-- start : sign -->
