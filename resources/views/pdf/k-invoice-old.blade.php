					 ...
					 <thead>
					  ...
					  <tbody>
					    ...
					    <tr>
					    	...
					    	<td class="car-information" colspan="4">
					    		<p>{{$carinformation->b_contract_desc1}}</p>
					    	</td>
					    </tr>
					    <tr>
					    	<td class="car-information">
					    ...
					    <tr>
					    	<td colspan="5">
					    		<div style="width: 100%;padding-top:10px; font-size:11px ;" class="text-center"> Das Fahrzeug wurde vom Käufer ausgiebig besichtigt und Probe gefahren.</div>
					    	</td>
					    </tr>
					    <tr>
					    	<td colspan="5">
					    		<div style="width: 100%;padding-bottom:36px;font-size: 11px;" class="text-center"> Gerichtsstand für beide ist Stuhr.</div>
					    	</td>
					    </tr>
					    <!-- end : notification -->
					    <!-- start : sign -->
