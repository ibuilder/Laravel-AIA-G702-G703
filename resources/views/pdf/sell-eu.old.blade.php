					  ...
					  <tbody>
					    ...
					    <tr >					      
					      <td colspan="5" style="padding-top: 30px !important; padding-bottom: 30px !important;" >
					      	...
					      	<div class="text-right" style="width: 30%; display: inline;">	Stuhr, den {{$carinformation->b_saledate}}	</div>
					      </td>
					    ...
					    <!-- start : notification -->
					    <tr>
					    	<td colspan="5" class="text-center" style="font-size: 13px;padding-top: 25px;">
					    ...
					    <tr>
					    	<td colspan="5" class="text-center" style="padding-top: 30px;padding-bottom: 30px;font-size: 16px;">
					    ...
					    <tr >
					    	<td colspan="5" class="text-left" style="padding-top: 50px !important;">
					    		...
					    		<div class="text-left" style="width: 49%; display: inline-block;" >
					    			<div  style="display: inline-block; width: 100%; margin-top: 3px !important; "><strong>NETTO - EU EXPORT</strong></div>						    							    			
					    		</div>
					    	</td>
					    </tr>
					    <tr >
					     ...
					     <tr>
					    	<td colspan="5" style="padding-top: 25px; font-size: 14px;">
					    		<div style="display: inline-block;">
					    			0€ per Überweisung erhalten (Deponat)
					    		</div>
