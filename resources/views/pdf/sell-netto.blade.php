                            ...
                            <td colspan="5" class="text-left" style="padding-top: 50px !important;">
                                <div style="width: 50%; display: inline-block;" >
                                    ...
                                    <div style="display:inline-block;width:58%; margin-top: 3px !important;">
                                        <div class="text-right"  style="display:inline-block;font-size:17px;margin-top: 15px; border-bottom:1px solid black;">
                                            <strong >&nbsp;&nbsp;&nbsp;@convert(($carinformation->b_value))€&nbsp;&nbsp;&nbsp;</strong>
                                        </div>

                                    </div>
                                </div>
                                <div class="text-left" style="width: 40%; display: inline-block;" >
                                    <div  style="display: inline-block; width: 100%; margin-top: 3px !important; border-bottom: 1px solid black;"><strong>NETTO - EXPORT</strong></div>
                                </div>
                            </td>
                        </tr>
                        <tr >
                            <td colspan="5" class="text-left" >
                                ...
                                <div style="width: 49%; display: inline-block;margin-top: -9px !important;" >
